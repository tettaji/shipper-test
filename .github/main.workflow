...
action "HTTP client" {
  ...
  needs = ["push"]
  args = "--auth-type=jwt --auth=$GITHUB_TOKEN POST api.github.com/repos/$GITHUB_REPOSITORY/dispatches Accept:application/vnd.github.everest-preview+json event_type=bla"
